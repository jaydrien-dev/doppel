...
function MemoryUsageBar({ used, limit }: { used: number; limit: number }) {
  ...
  return (
    <div style={{ padding: "14px 18px", borderRadius: 14, background: isAt ? "rgba(248,113,113,0.05)" : "rgba(255,255,255,0.02)", border: `1px solid ${isAt ? "rgba(248,113,113,0.15)" : isNear ? "rgba(251,191,36,0.12)" : "rgba(255,255,255,0.07)"}` }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          {isAt && <a href="/dashboard/billing" style={{ fontSize: 11, fontWeight: 500, padding: "3px 10px", borderRadius: 8, background: "rgba(248,113,113,0.12)", border: "1px solid rgba(248,113,113,0.25)", color: "rgba(248,113,113,0.80)", textDecoration: "none" }}>Upgrade plan</a>}
          {isNear && !isAt && <a href="/dashboard/billing" style={{ fontSize: 11, fontWeight: 500, padding: "3px 10px", borderRadius: 8, background: "rgba(251,191,36,0.08)", border: "1px solid rgba(251,191,36,0.20)", color: "rgba(251,191,36,0.70)", textDecoration: "none" }}>Upgrade plan</a>}
        </div>
      </div>
...
function DataPrivacyCard() {
  ...
  return (
    <div style={{ display: "flex", alignItems: "flex-start", gap: 14, padding: "14px 18px", borderRadius: 14, background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.08)" }}>
